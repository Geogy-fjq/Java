...
public class GourmetCoffee  {
	...
	private void setSalesFormatter(SalesFormatter newFormatter){
		if((newFormatter instanceof PlainTextSalesFormatter)||(newFormatter instanceof HTMLSalesFormatter)||(newFormatter instanceof XMLSalesFormatter)) {
			this.salesFormatter=newFormatter;
    	 displaySales();
		}
		else {
			stdErr.println("No such format.");
		}
	}
